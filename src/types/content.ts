...
export function isProjectFrontmatter(value: unknown): value is ProjectFrontmatter {
  ...
  return (
    ...
    Array.isArray(candidate.media) && candidate.media.every((media) => typeof media === "string") &&
    Array.isArray(candidate.outcomes) && candidate.outcomes.every((outcome) => typeof outcome === "string")
  );
}
